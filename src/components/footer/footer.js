...
export default function Footer() {
    return(
        <footer className="bg-black text-white">
            <div className="w-full flex pt-[80px] px-[40px]">
                {/* Logo */}
            ...
            {/* copy e redes sociais */}
            <div className="w-full flex justify-between px-[40px] py-[40px]">
                <div className="w-1/3 flex items-center text-center">
                    <p>© 2023 Só-Atos.</p>
                </div>
                <div className="w-1/3 flex justify-center">
                    <div className="card">
                        <a href="https://www.instagram.com/soatos_automacao/" target="_blank" className="socialContainer containerOne">
                        ...
                        <a href="https://web.facebook.com/people/S%C3%B3-Atos-Com%C3%A9rcio-e-Servi%C3%A7o-de-Automa%C3%A7%C3%A3o-Ltda/100095076877104/?locale=pt_BR" target="_blank" className="socialContainer containerTwo">
                        ...
                        <a href="https://wa.me/5511999120408?text=Ol%C3%A1,%20vim%20do%20site%20Soatos%20e%20gostaria%20de%20ter%20mais%20informa%C3%A7%C3%B5es%20a%20respeito%20de%20voc%C3%AAs." target="_blank" className="socialContainer containerFour">
